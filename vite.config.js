    ...
    build: {
        rollupOptions: {
            input: {
                ...
                index13: resolve(__dirname, "index13.html"),
                index14: resolve(__dirname, "index14.html"),
                index15: resolve(__dirname, "index15.html"),
                index16: resolve(__dirname, "index16.html"),
                index17: resolve(__dirname, "index17.html")
            }
        }
    }
})